 ...
 */
public class ArtifactsByEmployeeAEV extends AbstractXlsView {

    private final List<Map<String, Object>> objects;

    public ArtifactsByEmployeeAEV(List<Map<String, Object>> objects) {
    ...
    protected void buildExcelDocument(Map<String, Object> map,
        ...
        header.createCell(1).setCellValue("Количество находок");
