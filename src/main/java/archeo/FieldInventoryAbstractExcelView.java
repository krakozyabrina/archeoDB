 ...
 */
public class FieldInventoryAbstractExcelView extends AbstractXlsView {

    private final List<Map<String, Object>> objects;

    public FieldInventoryAbstractExcelView(List<Map<String, Object>> objects) {
    ...
    protected void buildExcelDocument(Map<String, Object> map,
        ...
        int rowNum = 1;
        for (Map<String, Object> fields : this.objects) {
